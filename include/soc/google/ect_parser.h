...
/*
 * Exynos Characteristic Table Parser Support.
 *
...
struct ect_info {
	...
	const struct file_operations dump_ops;
	char *dump_node_name;
	void *block_handle;
...
void ect_init(phys_addr_t address,
				phys_addr_t size);
int ect_parse_binary_header(void);
void *ect_get_block(char *block_name);
struct ect_dvfs_domain *ect_dvfs_get_domain(void *block,
				char *domain_name);
struct ect_pll *ect_pll_get_pll(void *block,
				char *pll_name);
struct ect_voltage_domain *ect_asv_get_domain(void *block,
				char *domain_name);
struct ect_rcc_domain *ect_rcc_get_domain(void *block,
				char *domain_name);
struct ect_mif_thermal_level *ect_mif_thermal_get_level(void *block,
				int mr4_level);
struct ect_ap_thermal_function *ect_ap_thermal_get_function(void *block,
				char *function_name);
...
struct ect_gen_param_table *ect_gen_param_get_table(void *block,
				char *table_name);
struct ect_bin *ect_binary_get_bin(void *block,
				char *binary_name);
struct ect_new_timing_param_size *ect_new_timing_param_get_key(void *block,
				unsigned long long key);
struct ect_pidtm_block *ect_pidtm_get_block(void *block,
				char *block_name);

void ect_init_map_io(void);

int ect_strcmp(char *src1,
		char *src2);
int ect_strncmp(char *src1,
		char *src2,
		int length);

unsigned long long ect_read_value64(unsigned int *address,
				int index);

#else

static inline void ect_init(phys_addr_t address,
				phys_addr_t size) {}
static inline int ect_parse_binary_header(void) { return 0; }
static inline void *ect_get_block(char *block_name) { return NULL; }
static inline struct ect_dvfs_domain *ect_dvfs_get_domain(void *block,
				char *domain_name) { return NULL; }
static inline struct ect_pll *ect_pll_get_pll(void *block,
				char *pll_name) { return NULL; }
static inline struct ect_voltage_domain *ect_asv_get_domain(void *block,
				char *domain_name) { return NULL; }
static inline struct ect_rcc_domain *ect_rcc_get_domain(void *block,
				char *domain_name) { return NULL; }
static inline struct ect_mif_thermal_level *ect_mif_thermal_get_level
					(void *block, int mr4_level)
					{ return NULL; }
static inline struct ect_ap_thermal_function *ect_ap_thermal_get_function
					(void *block, char *function_name)
					{ return NULL; }
static inline struct ect_margin_domain *ect_margin_get_domain(void *block,
				char *domain_name) { return NULL; }
static inline struct ect_timing_param_size *ect_timing_param_get_size
					(void *block, int size)
					{ return NULL; }
static inline struct ect_timing_param_size *ect_timing_param_get_key
					(void *block, unsigned long long key)
					{ return NULL; }
static inline struct ect_minlock_domain *ect_minlock_get_domain(void *block,
				char *domain_name) { return NULL; }
static inline struct ect_gen_param_table *ect_gen_param_get_table(void *block,
				char *table_name) { return NULL; }
static inline struct ect_bin *ect_binary_get_bin(void *block,
				char *binary_name) { return NULL; }
static inline struct ect_new_timing_param_size *ect_new_timing_param_get_key
					(void *block, unsigned long long key)
					{ return NULL; }
static inline struct ect_pidtm_block *ect_pidtm_get_block(void *block,
				char *block_name) { return NULL; }

static inline void ect_init_map_io(void) {}

static inline int ect_strcmp(char *src1,
				char *src2) { return -1; }
static inline int ect_strncmp(char *src1,
				char *src2,
				int length) { return -1; }

static inline unsigned long long ect_read_value64(unsigned int *address,
				int index) { return 0; }

...
/*
 * Google LWIS GS201 G3AA Interrupt And Event Defines
 *
 * Copyright (c) 2021 Google, LLC
 */

#ifndef DT_BINDINGS_LWIS_PLATFORM_GS201_G3AA_H_
#define DT_BINDINGS_LWIS_PLATFORM_GS201_G3AA_H_
...
#define G3AA_ERROR_INTERRUPTS_BASE (HW_EVENT_MASK + 96)

#define G3AA_ERROR_INTERRUPTS_HW_TIMEOUT 0
#define G3AA_ERROR_INTERRUPTS_BUS_ERROR 1
#define G3AA_ERROR_INTERRUPTS_AXI_READ_DATA_OVERFLOW 2
#define G3AA_ERROR_INTERRUPTS_AXI_WRITE_DATA_OVERFLOW 3
...
#define LWIS_PLATFORM_EVENT_ID_G3AA_HW_TIMEOUT \
	EVENT_ID(G3AA_ERROR_INTERRUPTS_BASE, \
	   G3AA_ERROR_INTERRUPTS_HW_TIMEOUT)
#define LWIS_PLATFORM_EVENT_ID_G3AA_BUS_ERROR \
	EVENT_ID(G3AA_ERROR_INTERRUPTS_BASE, \
	   G3AA_ERROR_INTERRUPTS_BUS_ERROR)
#define LWIS_PLATFORM_EVENT_ID_G3AA_AXI_READ_DATA_OVERFLOW \
	EVENT_ID(G3AA_ERROR_INTERRUPTS_BASE, \
	   G3AA_ERROR_INTERRUPTS_AXI_READ_DATA_OVERFLOW)
#define LWIS_PLATFORM_EVENT_ID_G3AA_AXI_WRITE_DATA_OVERFLOW \
	EVENT_ID(G3AA_ERROR_INTERRUPTS_BASE, \
	   G3AA_ERROR_INTERRUPTS_AXI_WRITE_DATA_OVERFLOW)
#endif /* DT_BINDINGS_LWIS_PLATFORM_GS201_G3AA_H_ */

...
#define DPP_CSC_TYPE_SHIFT			(18)
#define DPP_CSC_TYPE(_v)			((_v) << DPP_CSC_TYPE_SHIFT)
...
#define DPP_CSC_RANGE_SHIFT			(17)
#define DPP_CSC_RANGE_LIMITED			(0x0 << 17)
#define DPP_CSC_RANGE_FULL			(0x1 << 17)
#define DPP_CSC_MODE(_v)			((_v) << 16)
#define DPP_CSC_MODE_MASK			(1 << 16)
#define DPP_CSC_MODE_HARDWIRED			(0x0 << 16)
#define DPP_CSC_MODE_CUSTOMIZED			(0x1 << 16)
...
#define DPP_H_COEF(n, s, x)			(0x290 + (n) * 0x4 +	\
						(s) * 0x24 + (x) * 0x200)
#define DPP_V_COEF(n, s, x)			(0x200 + (n) * 0x4 +	\
						(s) * 0x24 + (x) * 0x200)

...
#define FEC_DECODE_EN_4TH_SEL(_v)		       (((_v)&0x1) << 4)
#define FEC_DECODE_EN_4TH_SEL_MASK		       (0x1 << 4)
#define FEC_DECODE_DIS_4TH_SEL(_v)		       (((_v)&0x1) << 3)
#define FEC_DECODE_DIS_4TH_SEL_MASK		       (0x1 << 3)
...
#define FEC_PM_HOLD_LINK_LINE_BOUNDARY_COUNTER_SET(_v) (((_v)&0x1) << 1)
#define FEC_PM_HOLD_LINK_LINE_BOUNDARY_COUNTER_MASK    (0x1 << 1)
#define FEC_PM_HOLD_CIPHER_SET(_v)		       (((_v)&0x1) << 0)
#define FEC_PM_HOLD_CIPHER_MASK			       (0x1 << 0)

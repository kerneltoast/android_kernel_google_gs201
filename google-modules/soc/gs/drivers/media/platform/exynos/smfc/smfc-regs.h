...
#define REG_SEC_IMAGE_SO_PLANE1		0x094
#define REG_SEC_IMAGE_PO_PLANE1		0x098
#define REG_SEC_IMAGE_SO_PLANE(n)	(REG_SEC_IMAGE_SO_PLANE1 + (n) * 12)
#define REG_SEC_IMAGE_PO_PLANE(n)	(REG_SEC_IMAGE_PO_PLANE1 + (n) * 12)

...
static const struct ufs_cal_phy_cfg init_cfg_evt0[] = {
	...
	{0x0000, 0x10C, 0x10, PMD_ALL, PHY_PMA_COMN, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x118, 0x48, PMD_ALL, PHY_PMA_COMN, BRD_ALL^BRD_ZEBU},

	{0x0000, 0x800, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x804, 0x06, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x808, 0x06, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x80C, 0x0A, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x810, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x814, 0x11, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},

	{0x0000, 0x81C, 0x0C, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},

	{0x0000, 0xB84, 0xC0, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x8B4, 0xB8, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},

	{0x0000, 0x8D0, 0x60, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x8E0, 0x13, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x8E4, 0x48, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x8E8, 0x01, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x8EC, 0x25, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x8F0, 0x2A, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x8F4, 0x01, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x8F8, 0x13, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x8FC, 0x13, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x900, 0x4A, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x90C, 0x40, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x910, 0x02, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},

	{0x0000, 0x974, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},

	{0x0000, 0x978, 0x3F, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x97C, 0xFF, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},

	{0x0000, 0x9CC, 0x33, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x9D0, 0x50, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},

	{0x0000, 0xA10, 0x02, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xA14, 0x02, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},

	{0x0000, 0xA88, 0x04, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x9F4, 0x01, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xBE8, 0x01, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},

	{0x0000, 0xA18, 0x03, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xA1C, 0x03, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xA20, 0x03, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xA24, 0x03, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},

	{0x0000, 0xACC, 0x04, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},

	{0x0000, 0xAD8, 0x0B, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xADC, 0x0B, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xAE0, 0x0B, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xAE4, 0x0B, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xAE8, 0x0B, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xAEC, 0x06, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xAF0, 0x06, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xAF4, 0x06, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xAF8, 0x06, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},

	{0x0000, 0xB90, 0x1A, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xBB4, 0x25, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x9A4, 0x1A, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xBD0, 0x2F, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},

	{0x0000, 0xD2C, 0x01, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xD30, 0x23, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xD34, 0x23, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xD38, 0x45, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xD3C, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xD40, 0x31, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xD44, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xD48, 0x02, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xD4C, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xD50, 0x01, PMD_ALL, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},

	{0x0000, 0x10C, 0x18, PMD_ALL, PHY_PMA_COMN, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x10C, 0x00, PMD_ALL, PHY_PMA_COMN, BRD_ALL^BRD_ZEBU},
	{0x0000, 0xCE0, 0x08, PMD_ALL, PHY_EMB_CAL_WAIT, BRD_ALL^BRD_ZEBU},

	{0x0000, 0x584, 0x44, PMD_ALL, PHY_PMA_TRSV, BRD_ZEBU},
	{0x0000, 0x5A4, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ZEBU},
	{0x0000, 0x644, 0x05, PMD_ALL, PHY_PMA_TRSV, BRD_ZEBU},
	{0x0000, 0x6B0, 0x00, PMD_ALL, PHY_PMA_TRSV, BRD_ZEBU},
	{0x0000, 0x6E4, 0x10, PMD_ALL, PHY_PMA_TRSV, BRD_ZEBU},
	{0x0000, 0x708, 0x01, PMD_ALL, PHY_PMA_TRSV, BRD_ZEBU},
...
static const struct ufs_cal_phy_cfg calib_of_hs_rate_a[] = {
	...
	{0x0000, 0xDA4, 0x11, PMD_HS, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},
	{0x0000, 0x918, 0x03, PMD_HS, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},

	{0x0000, 0x708, 0x08, PMD_HS, PHY_PMA_TRSV, BRD_ZEBU},
...
static const struct ufs_cal_phy_cfg post_calib_of_hs_rate_a[] = {
	...
	{0x0000, 0x918, 0x01, PMD_HS, PHY_PMA_TRSV, BRD_ALL^BRD_ZEBU},

	{0x0000, 0x7B4, 0x02, PMD_HS, PHY_CDR_WAIT, BRD_ZEBU},
	{0x0000, 0x7B8, 0x08, PMD_HS, PHY_CDR_WAIT, BRD_ZEBU},

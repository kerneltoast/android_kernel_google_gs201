...
static struct itmon_nodeinfo vec_d0[] = {
	...
	{S_NODE, "ALIVE",	0x1E633000, 1, 1, 0, 0},
	{S_NODE, "CPUCL0",	0x1E643000, 1, 1, 0, 0},
	{S_NODE, "EH",		0x1E653000, 1, 1, 0, 0},
	{S_NODE, "GIC",		0x1E663000, 1, 1, 0, 0},
	{S_NODE, "MIF0",	0x1E673000, 1, 1, 0, 0},
	{S_NODE, "MIF1",	0x1E683000, 1, 1, 0, 0},
	{S_NODE, "MIF2",	0x1E693000, 1, 1, 0, 0},
	{S_NODE, "MIF3",	0x1E6A3000, 1, 1, 0, 0},
	{S_NODE, "MISC",	0x1E6B3000, 1, 1, 0, 0},
	{S_NODE, "PERIC0",	0x1E6C3000, 1, 1, 0, 0},
	{S_NODE, "PERIC1",	0x1E6D3000, 1, 1, 0, 0},
	{T_S_NODE, "NOCL0_M0",	0x1E6E3000, 1, 1, 0, 0},
	{T_S_NODE, "NOCL0_M1",	0x1E6F3000, 1, 1, 0, 0},
	{T_S_NODE, "NOCL0_M2",	0x1E703000, 1, 1, 0, 0},
	{S_NODE, "P0_NOCL0",	0x1E713000, 1, 1, 0, 0},
	{S_NODE, "P1_NOCL0",	0x1E723000, 1, 1, 0, 0},
	{S_NODE, "P2_NOCL0",	0x1E733000, 1, 1, 0, 0},
	{S_NODE, "SLC",		0x1E743000, 1, 1, 0, 0},
};

static struct itmon_nodeinfo vec_d1[] = {
	{T_M_NODE, "NOCL1B_S0",	0x1EC03000, 1, 1, 0, 0},
	{S_NODE, "AOC",		0x1EC13000, 1, 1, 0, 0},
	{S_NODE, "GSA",		0x1EC23000, 1, 1, 0, 0},
	{S_NODE, "HSI0",	0x1EC33000, 1, 1, 0, 0},
	{S_NODE, "HSI1",	0x1EC43000, 1, 1, 0, 0},
	{S_NODE, "P0_NOCL1B",	0x1EC53000, 1, 1, 0, 0},
	{S_NODE, "P1_NOCL1B",	0x1EC63000, 1, 1, 0, 0},
};

static struct itmon_nodeinfo vec_d2[] = {
	{T_M_NODE, "NOCL2A_S0",	0x1F203000, 1, 1, 0, 0},
	{S_NODE, "BO",		0x1F213000, 1, 1, 0, 0},
	{S_NODE, "CSIS",	0x1F223000, 1, 1, 0, 0},
	{S_NODE, "DISP",	0x1F233000, 1, 1, 0, 0},
	{S_NODE, "DNS",		0x1F243000, 1, 1, 0, 0},
	{S_NODE, "DPU",		0x1F253000, 1, 1, 0, 0},
	{S_NODE, "GDC",		0x1F263000, 1, 1, 0, 0},
	{S_NODE, "G2D",		0x1F273000, 1, 1, 0, 0},
	{S_NODE, "G3AA",	0x1F283000, 1, 1, 0, 0},
	{S_NODE, "HSI2",	0x1F293000, 1, 1, 0, 0},
	{S_NODE, "IPP",		0x1F2A3000, 1, 1, 0, 0},
	{S_NODE, "ITP",		0x1F2B3000, 1, 1, 0, 0},
	{S_NODE, "MCSC",	0x1F2C3000, 1, 1, 0, 0},
	{S_NODE, "MFC",		0x1F2D3000, 1, 1, 0, 0},
	{S_NODE, "PDP",		0x1F2E3000, 1, 1, 0, 0},
	{S_NODE, "TNR",		0x1F2F3000, 1, 1, 0, 0},
	{S_NODE, "P0_NOCL2A",	0x1F303000, 1, 1, 0, 0},
	{S_NODE, "P1_NOCL2A",	0x1F313000, 1, 1, 0, 0},
};

static struct itmon_nodeinfo vec_d3[] = {
	{T_M_NODE, "NOCL1A_S0",	0x20603000, 1, 1, 0, 0},
	{S_NODE, "AUR",		0x20613000, 1, 1, 0, 0},
	{S_NODE, "G3D",		0x20623000, 1, 1, 0, 0},
	{S_NODE, "TPU",		0x20633000, 1, 1, 0, 0},
	{S_NODE, "P0_NOCL1A",	0x20643000, 1, 1, 0, 0},
	{S_NODE, "P1_NOCL1A",	0x20653000, 1, 1, 0, 0},
};
...
static struct itmon_nodeinfo vec_p2[] = {
	...
	{S_NODE, "P0_NOCL2A",	0x1F253000, 1, 1, 0, 0, TMOUT, 1},
	{S_NODE, "P1_NOCL2A",	0x1F213000, 1, 1, 0, 0, TMOUT, 1},
...
static struct itmon_nodeinfo vec_p3[] = {
	...
	{S_NODE, "G3D",		0x20633000, 1, 1, 0, 0, TMOUT, 1},
...
static int itmon_probe(struct platform_device *pdev)
{
	...
	dev_info(&pdev->dev, "success to probe gs201 ITMON driver\n");

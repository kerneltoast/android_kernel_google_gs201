...
struct VL53L1_per_vcsel_period_offset_cal_data_t {
...
struct VL53L1_zone_objects_t {
	...
	struct VL53L1_object_data_t VL53L1_p_002[VL53L1_MAX_RANGE_RESULTS];
...
struct VL53L1_zone_results_t {
	uint8_t max_zones;
	uint8_t active_zones;
	struct VL53L1_zone_objects_t VL53L1_p_002[VL53L1_MAX_USER_ZONES];
};
...
struct VL53L1_zone_histograms_t {
	uint8_t max_zones;
	uint8_t active_zones;
	struct VL53L1_zone_hist_info_t VL53L1_p_002[VL53L1_MAX_USER_ZONES];
};
...
struct VL53L1_zone_calibration_results_t {
	...
	uint8_t max_zones;
	uint8_t active_zones;
	struct VL53L1_zone_calibration_data_t VL53L1_p_002[VL53L1_MAX_USER_ZONES];
};
...
struct VL53L1_zone_private_dyn_cfgs_t {
	uint8_t max_zones;
	uint8_t active_zones;
	struct VL53L1_zone_private_dyn_cfg_t VL53L1_p_002[VL53L1_MAX_USER_ZONES];
};
...
struct VL53L1_LLDriverData_t {
	...
	uint8_t wArea1[1536];
	uint8_t wArea2[512];
	struct VL53L1_per_vcsel_period_offset_cal_data_t per_vcsel_cal_data;
	uint8_t bin_rec_pos;

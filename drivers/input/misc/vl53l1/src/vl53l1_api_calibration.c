	...
	VL53L1_Error *pcal_status)
{
	...
	struct VL53L1_xtalkextract_config_t *pX = &(pdev->xtalk_extract_cfg);
	struct VL53L1_xtalk_config_t *pC = &(pdev->xtalk_cfg);
	struct VL53L1_xtalk_calibration_results_t *pXC = &(pdev->xtalk_cal);
...
VL53L1_Error VL53L1_get_and_avg_xtalk_samples(
		...
		struct VL53L1_xtalk_range_results_t *pXR,
		...
		struct VL53L1_histogram_bin_data_t *pavg_histo)
{
	...
	struct VL53L1_range_results_t *prs =
			(struct VL53L1_range_results_t *) pdev->wArea1;

	struct VL53L1_range_data_t *prange_data;
	struct VL53L1_xtalk_range_data_t *pxtalk_range_data;
	...
	VL53L1_Error *pcal_status)
{
	...
	struct VL53L1_range_data_t *pRData = NULL;
	struct VL53L1_offset_range_data_t *pfs = NULL;
	struct VL53L1_general_config_t *pG = &(pdev->gen_cfg);
	struct VL53L1_additional_offset_cal_data_t *pAO = &(pdev->add_off_cal_data);
	...
	VL53L1_Error *pcal_status)
{
	...
	struct VL53L1_range_results_t *pRR =
			(struct VL53L1_range_results_t *) pdev->wArea1;
	...
	struct VL53L1_xtalk_histogram_shape_t *pxtalk_shape)
{
	...
	VL53L1_Error status = VL53L1_ERROR_NONE;
	struct VL53L1_xtalk_calibration_results_t *pX = pxtalk_cal;

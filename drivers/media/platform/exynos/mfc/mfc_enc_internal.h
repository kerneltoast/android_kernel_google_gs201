...
struct mfc_fmt enc_formats[] = {
	...
	{
		.name = "4:2:0 2 Planes Y/CbCr 8bit SBWC",
	...
	{
		.name = "4:2:0 2 Planes Y/CbCr 10bit SBWC",
	...
	{
		.name = "4:2:0 2 Planes Y/CrCb 8bit SBWC",
	...
	{
		.name = "4:2:0 2 Planes Y/CrCb 10bit SBWC",
	...
	{
		.name = "4:2:0 2 Planes Y/CbCr 8bit SBWC single",
	...
	{
		.name = "4:2:0 2 Planes Y/CbCr 10bit SBWC single",
	...
	{
		.name = "4:2:0 2 Planes Y/CbCr 8bit SBWC Lossy",
	...
	{
		.name = "4:2:0 2 Planes Y/CbCr 10bit SBWC Lossy",
	...
	{
		.name = "4:2:0 2 Planes Y/CbCr 8bit SBWC Lossy single",
	...
	{
		.name = "4:2:0 2 Planes Y/CbCr 10bit SBWC Lossy single",
	...
	{
		.name = "4:2:0 2 Planes Y/CbCr 8bit AFBC",
		.fourcc = V4L2_PIX_FMT_NV12M_AFBC_8B,
		.codec_mode = MFC_FORMATS_NO_CODEC,
		.type = MFC_FMT_FRAME | MFC_FMT_AFBC,
		.num_planes = 1,
		.mem_planes = 1,
	},
	{
		.name = "4:2:0 2 Planes Y/CbCr 10bit AFBC",
		.fourcc = V4L2_PIX_FMT_NV12M_AFBC_10B,
		.codec_mode = MFC_FORMATS_NO_CODEC,
		.type = MFC_FMT_FRAME | MFC_FMT_AFBC,
		.num_planes = 1,
		.mem_planes = 1,
